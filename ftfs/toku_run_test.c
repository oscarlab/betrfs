...
//	{ "test-xa-prepare", test_test_xa_prepare , 5},
    ...
    //{"clone-subtree-1",test_clone_subtree_1, 5},
    //{"clone-subtree-2",test_clone_subtree_2, 5},
    //{"clone-subtree-3",test_clone_subtree_3, 5},
    //{"rename-subtree",test_rename_subtree, 5},
    //{"seq_clone", test_seq_clone, 5}
};
