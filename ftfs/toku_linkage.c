...
{
  /* The dummy code below is just to prevent the compiler from
     complaining about statements w/ no effect. */
  return
    (long)memcmp   |
    (long)memcpy   |
    (long)memmove  |
...
/* The only usage of system is to call gettid.  Just inline the
