...
#if defined(_RANDOM_TEST) && defined(_LARGE_MEM)
static void
...
extern "C" int test_sort_tmpl(void);
int
test_sort_tmpl(void)
{
    zero_array_test();
    ...
    #endif
    #ifndef _LARGE_MEM
    printf("\n random_array_test(10000000), random_array_test_64(1000000), already_sorted_test(10000000) and already_sorted_test(10000000) are skipped, please revisit once toku_xmalloc supports large allocation");
    #endif
    return 0;
}
