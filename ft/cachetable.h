...
extern "C" void toku_cachetable_create(CACHETABLE *result, long size_limit, LSN initial_lsn, TOKULOGGER);
...
uint64_t toku_cachetable_reserve_memory(CACHETABLE, int fraction, uint64_t upper_bound);
