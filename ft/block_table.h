...
// refc
int toku_blocknum_dec_refc(BLOCK_TABLE bt, BLOCKNUM *bp, FT ft, bool for_checkpoint);
int toku_blocknum_maybe_dec_refc(BLOCK_TABLE bt, BLOCKNUM b, FT Ft);
void toku_blocknum_inc_refc(BLOCK_TABLE bt, BLOCKNUM b, FT ft);
bool toku_blocknum_multi_copy(BLOCK_TABLE bt, BLOCKNUM b);
bool toku_blocknum_maybe_break_cow(BLOCK_TABLE bt, BLOCKNUM b, BLOCKNUM *res, FT ft);
