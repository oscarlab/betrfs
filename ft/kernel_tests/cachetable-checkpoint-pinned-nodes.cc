...
static uint64_t clean_val = 0;
static uint64_t dirty_val = 0;

extern bool check_me;
...
extern "C" int test_cachetable_checkpoint_pinned_nodes(void);

int test_cachetable_checkpoint_pinned_nodes() 
{
  initialize_dummymsn();
