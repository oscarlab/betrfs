...
extern bool check_flush;
extern bool expect_full_flush;
extern bool expect_pe;
...
extern "C" int test_cachetable_eviction_close2(void);

int test_cachetable_eviction_close2(void) {
    initialize_dummymsn();
