...
static int64_t data[NUM_ELEMENTS];
static int64_t checkpointed_data[NUM_ELEMENTS];
static PAIR data_pair[NUM_ELEMENTS];

static uint32_t time_of_test;
...
extern "C" int test_cachetable_put_checkpoint(void);

int test_cachetable_put_checkpoint(void) {
    initialize_dummymsn();
