...
static bool flush_completed;
static bool pf_called;
...
extern "C" int test_cachetable_clone_partial_fetch_pinned_node(void);
  
int
test_cachetable_clone_partial_fetch_pinned_node(void) {
    initialize_dummymsn();
