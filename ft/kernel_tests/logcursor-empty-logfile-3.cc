...
extern "C" int test_logcursor_empty_logfile_3(void);
int
test_logcursor_empty_logfile_3 (void) {
    ...
    // SCB (9/4/19): We don't actually do that, the log file no longer supports trimming
    {
        LSN trim_lsn;
        trim_lsn.lsn = (2*N)-1;
