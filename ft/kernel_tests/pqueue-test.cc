...
static int run_test(void) 
{
	...
	/*Dynamicaaly allocating memory to reduce local stack size*/
	DBT *keys  = (DBT*) toku_malloc(sizeof(DBT) * n_sources);
	DBT *vals  = (DBT*) toku_malloc(sizeof(DBT) * n_sources);
	...
	/*Dynamically allocating memory to reduce local stack size*/
	DBT *more_keys  = (DBT*) toku_malloc(sizeof(DBT) * 20);
	DBT *more_vals  = (DBT*) toku_malloc(sizeof(DBT) * 20);
	...
	/*Dynamically allocating memory to reduce local stack size*/
	DBT *keys3  = (DBT*) toku_malloc(sizeof(DBT) * 10);
	DBT *vals3  = (DBT*) toku_malloc(sizeof(DBT) * 10);
...
found_duplicate6:
	...
	/*Dynamically allocating memory to reduce local stack size*/
	DBT *keys4  = (DBT*) toku_malloc(sizeof(DBT) * 10);
	DBT *vals4  = (DBT*) toku_malloc(sizeof(DBT) * 10);	
