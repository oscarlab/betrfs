...
static bool clone_flush_started;
static bool clone_flush_completed;
...
extern "C" int test_cachetable_clone_checkpoint(void);
int
test_cachetable_clone_checkpoint(void) {
    initialize_dummymsn();
