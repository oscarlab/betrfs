...
void manager_unit_test::test_create_destroy(void) {
    ...
    printf("manager_create_destroy > invariants started.\n");    
    ...
    printf("manager_create_destroy > invariants finished.\n"); 
