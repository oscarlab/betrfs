...
locktree::manager mgr_tor;
void locktree_unit_test::test_overlapping_relock(void) {
    mgr_tor.create(nullptr, nullptr, nullptr, nullptr);
    DESCRIPTOR desc = nullptr;
    DICTIONARY_ID dict_id = { 1 };
    locktree *lt = mgr_tor.get_lt(dict_id, desc, compare_dbts, nullptr);
...
#undef ACQUIRE_LOCK
    ...
    mgr_tor.release_lt(lt);
    mgr_tor.destroy();
}

} /* namespace toku */

extern "C" int test_locktree_overlapping(void);

int test_locktree_overlapping(void) {
