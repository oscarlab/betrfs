...
void concurrent_tree_unit_test::test_lkr_insert_remove(void) {
    ...
    concurrent_tree * treep = (concurrent_tree *) toku_xmalloc(sizeof(concurrent_tree));
    treep->create(&cmp);
...
extern "C" int test_concurrent_tree_lkr_insert_remove(void);
int test_concurrent_tree_lkr_insert_remove(void) {
