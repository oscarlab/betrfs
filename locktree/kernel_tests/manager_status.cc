...
static locktree::manager mgr;
static lock_request request_b;
static range_buffer buffer;
static LTM_STATUS_S status;
...
extern "C" int test_manager_status(void);
int test_manager_status(void) {
