...
locktree::manager mgr_pending;
void lock_request_unit_test::test_start_pending(void) {
    int r;
    locktree *lt;
    lock_request request;

    mgr_pending.create(nullptr, nullptr, nullptr, nullptr);
    DICTIONARY_ID dict_id = { 1 };
    lt = mgr_pending.get_lt(dict_id, nullptr, compare_dbts, nullptr);
    ...
    request.destroy();
    mgr_pending.release_lt(lt);
    mgr_pending.destroy();
}

} /* namespace toku */
extern "C" int test_lockrequest_pending(void);
int test_lockrequest_pending(void) {
