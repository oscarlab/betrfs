...
void lock_request_unit_test::test_wait_time_callback(void) {
    ...
    p_mgr->set_lock_wait_time(10*1000, my_lock_wait_time_callback);
    DICTIONARY_ID dict_id = { 1 };
    lt = p_mgr->get_lt(dict_id, nullptr, compare_dbts, nullptr);
    ...
    r = request_b.wait(p_mgr->get_lock_wait_time());
...
extern "C" int test_lock_request_wait_time_callback(void); 
int test_lock_request_wait_time_callback(void) {
