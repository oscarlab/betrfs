...
test_loader_abort (bool do_compress, bool abort_loader, bool abort_txn) {
    ...
    CKERR(r);
    r = env->open(env, testfile, DB_INIT_MPOOL|DB_CREATE|DB_THREAD |DB_INIT_LOCK|DB_INIT_LOG|DB_INIT_TXN|DB_PRIVATE, S_IRWXU+S_IRWXG+S_IRWXO); CKERR(r);
...
extern "C" int test_test_5469(void);
int test_test_5469(void) {
    pre_setup();
