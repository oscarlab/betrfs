...
extern "C" int test_test_5015(void);
int test_test_5015(void) {
    ...
    r = env->open(env, TOKU_TEST_ENV_DIR_NAME, DB_CREATE | DB_PRIVATE | DB_INIT_MPOOL | DB_INIT_TXN | DB_INIT_LOCK | DB_INIT_LOG, 0); assert(r == 0);
