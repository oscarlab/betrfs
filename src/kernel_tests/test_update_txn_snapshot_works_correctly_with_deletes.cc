...
static const int to_delete[] = { 0, 1, 1, 1, 0, 0, 1, 0, 1, 0 };
...
extern "C" int test_test_update_txn_snapshot_works_correctly_with_deletes(void);
int test_test_update_txn_snapshot_works_correctly_with_deletes(void) {
    pre_setup();
    setup();
