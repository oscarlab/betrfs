...
extern "C" int test_print_engine_status(void);
int test_print_engine_status(void) {
    ...
    char *panic_string = (char *)toku_xmalloc(panic_string_len * sizeof *panic_string);
            ...
            case TOKUTIME:
                {
                    ...
                    printf("tokutime_to_secons not implemented\n");
                }
                break;
            default:
