...
static const int oper_per_iter = 5001;  // not-very-nice odd number (not a multiple of a power of two)
...
extern "C" int test_checkpoint_stress(void);
int test_checkpoint_stress(void) {
