...
static const int to_update[] = { 0, 1, 1, 1, 0, 0, 1, 0, 1, 0 };
...
extern "C" int test_test_update_txn_snapshot_works_concurrently(void);
int test_test_update_txn_snapshot_works_concurrently(void) {
    pre_setup();
    setup();
