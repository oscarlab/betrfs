...
extern "C" int test_recover_update_broadcast_changes_values_before_checkpoint(void);
int test_recover_update_broadcast_changes_values_before_checkpoint(void) {
{
    bool do_test = false;
