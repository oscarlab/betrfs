...
static volatile int reader_start_count = 0;

static const int W = 10;
static volatile int writer_done_count = 0;
...
extern "C" int test_checkpoint_fairness(void);
int test_checkpoint_fairness(void) {
    pre_setup();
