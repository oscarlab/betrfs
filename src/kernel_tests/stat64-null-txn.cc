...
test_stat64 (unsigned int N) {
    ...
    r = env->open(env, TOKU_TEST_ENV_DIR_NAME, DB_INIT_LOCK|DB_INIT_MPOOL|DB_CREATE|DB_PRIVATE, S_IRWXU+S_IRWXG+S_IRWXO); CKERR(r);
...
extern "C" int test_stat64_null_txn(void);
int test_stat64_null_txn(void) {
    pre_setup();
    test_stat64(40000);
    test_stat64(400000);
    post_teardown();
