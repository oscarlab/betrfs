...
extern "C" int toku_ydb_init(void);

// Called when the ydb library is unloaded.
extern "C" void toku_ydb_destroy(void);
...
extern "C" void* toku_get_lookup_create_query_val(void *extra) __attribute__((__visibility__("default")));
